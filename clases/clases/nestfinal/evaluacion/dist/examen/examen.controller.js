...
const create_examen_dto_1 = require("./dto/create-examen.dto");
const update_examen_dto_1 = require("./dto/update-examen.dto");
let ExamenController = class ExamenController {
    examenService;
    constructor(examenService) {
        this.examenService = examenService;
    }
    create(createExamenDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_examen_dto_1.CreateExamenDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_examen_dto_1.UpdateExamenDto]),
    __metadata("design:returntype", void 0)
